      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-6 tracking-tight">
            {t('title')} <span className="text-[#A38758] font-light">| Premium Anti-Aging</span>
          </h1>
          ...
          <div className="space-y-12">
            <div>
              ...
              <div className="bg-[#FAFAF8] border border-[#E8E6E1] rounded-lg p-6 premium-shadow">
                <p className="text-[#A38758] font-semibold text-lg mb-4 text-center border-b border-[#E8E6E1] pb-3">
                  {t('highlight1')}
                </p>
                <ul className="space-y-3 text-[#7A7A7A] font-light text-sm">
                  <li className="flex items-center"><span className="w-1 h-1 bg-[#A38758] rounded-full mr-3"></span>{t('list1_1')}</li>
                  <li className="flex items-center"><span className="w-1 h-1 bg-[#A38758] rounded-full mr-3"></span>{t('list1_2')}</li>
                  <li className="flex items-center"><span className="w-1 h-1 bg-[#A38758] rounded-full mr-3"></span>{t('list1_3')}</li>
                  <li className="flex items-center"><span className="w-1 h-1 bg-[#A38758] rounded-full mr-3"></span>{t('list1_4')}</li>
                  <li className="flex items-center"><span className="w-1 h-1 bg-[#A38758] rounded-full mr-3"></span>{t('list1_5')}</li>
                </ul>
              </div>
            </div>
            <div>
